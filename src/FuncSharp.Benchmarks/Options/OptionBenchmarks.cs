...
namespace FuncSharp.Benchmarks.Options
{
    [MemoryDiagnoser]
    public class OptionBenchmarks
    {
        ...
        [Benchmark]
        public IOption<string> EmptyToConstant()
        {
        ...
        {
            return NonEmptyOption.FlatMap(o => "non-empty".ToOption());
        }
        ...
        {
            return NonEmptyOption.OrElse(_ => Option.Valued("else"));
        }
