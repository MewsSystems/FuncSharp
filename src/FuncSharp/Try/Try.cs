...
public struct Try<TSuccess, TError>
{
    ...
    {
        return IsSuccess
            ? new Try<TSuccessTarget, TError>(f(Success.GetOrDefault()))
            : new Try<TSuccessTarget, TError>(Error.GetOrDefault());
    }
    ...
    {
        return IsSuccess
            ? new Try<TSuccessTarget, TErrorTarget>(success(Success.GetOrDefault()))
            : new Try<TSuccessTarget, TErrorTarget>(error(Error.GetOrDefault()));
    }
    ...
    {
        return IsSuccess
            ? new Try<TSuccess, TErrorTarget>(Success.GetOrDefault())
            : new Try<TSuccess, TErrorTarget>(f(Error.GetOrDefault()));
    }
