...
namespace FuncSharp
{
    public static class CoproductExtensions
    {
        ...
        /// </summary>
        public static Product3<int, int, object> CoproductRepresentation(this Coproduct c)
        {
        ...
        /// </summary>
        public static int CoproductHashCode(this Coproduct c)
        {
        ...
        /// </summary>
        public static bool CoproductEquals(this Coproduct c1, object that)
        {
            if (that is Coproduct c2 && c1 != null && c2 != null && c1.GetType() == c2.GetType())
            {
        ...
        /// </summary>
        public static string CoproductToString(this Coproduct c)
        {
            return
