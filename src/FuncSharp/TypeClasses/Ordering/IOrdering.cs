...
namespace FuncSharp
{
    ...
    public static class IOrderingExtensions
    {
        /// <summary>
        ...
        /// </summary>
        public static IEnumerable<A> Order<A>(this IOrdering<A> o, IEnumerable<A> values, Order order = FuncSharp.Order.Ascending)
        {
            var result = values.ToList();
            var comparer = new OrderingComparer<A>(o, order);
